...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.ssafy.travery.model.mapper.*.*(..)) ||execution(* com.ssafy.travery.model.service.*.*(..)) ")
...
//	}
	...
	@AfterReturning(value = "execution(* com.ssafy.travery.model.mapper.*.list*(..)) ||execution(* com.ssafy.travery.model.service.*.list*(..)) ", returning = "obj")
	...
	@AfterThrowing(value = "execution(* com.ssafy.travery.model.mapper.*.list*(..)) ||execution(* com.ssafy.travery.model.service.*.list*(..)) ", throwing = "exception")
	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
		logger.debug("exception : {}", exception);
	}

	@After(value = "execution(* com.ssafy.travery.model.mapper.*.list*(..)) ||execution(* com.ssafy.travery.model.service.*.list*(..)) ")
