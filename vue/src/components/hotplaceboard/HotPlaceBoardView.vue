        ...
        <b-col cols="12">
          <b-form>
            <div class="mb-3 d-flex flex-column align-items-start">
              ...
              <b-form-textarea v-model="content" rows="20" style="border-color: black;" readonly></b-form-textarea>
            </div>
            <b-col cols='auto' class="text-center">
              <b-button v-if="isWriter" class="btn btn-outline-primary mb-3" style="background-color: white;">
                <router-link v-if="isWriter" :to="{ name: 'hotplaceboardmodify',params: { articleNo:`${this.articleNo}` }}">글수정</router-link>
              </b-button>
...
export default {
  ...
  methods: {
    ...
    deleteBoard() {
      http.delete(`/hotplaceboard/${this.articleNo}`)
      .then(() => {
